// AUTO-GENERATED from skills/incident-report/SKILL.md by scripts/sync-prompts.ts
// Do not edit this file by hand. Edit the SKILL.md, then re-run sync-prompts.

export const incidentReportPrompt = {
  ...
  content: `# Incident Report — staff capture skill
