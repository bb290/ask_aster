...
* **07-23** — Inspected By on Site Visit and Inspections: tap your name from the button list (or Other and type it) before submitting — required. The name prints in the checklist comment and the PDF. The roster is a module field, editable as staff changes.
