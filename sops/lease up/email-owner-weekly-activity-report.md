...
* A leasing issue may require management's attention.
...
* **# of showings** completed that week.
* **Feedback** from the Leasing Team and/or prospective Residents.
* **Suggestions to improve the property** (if applicable).
* **Recommendations to improve the listing** or strategy.
...
* Remove Last Month Rent requirement
* Reduce income requirement (3x → 2.5x → 2x rent)
* Reduce credit requirement (700 → 650 → 600)
* Reduce security deposit
* Allow or expand pet policy
